...
//通知の取得
$sql = "select dream.id as dreamid, title, body, user_id, name, screen_name from dream inner join account on dream.user_id = account.id where delete_flag is null order by dream.id desc limit 100";
