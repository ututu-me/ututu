        ...
        <div class="container">
            <div class="content">
                <div class="box has-background-light">
                    <h3 class="title">UTUTU 利用規約</h3>
                    <p class="content">
                        <span>この利用規約（以下，「本規約」といいます。）は，UTUTU（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</span>
                        <h4 class="subtitle">第1条（適用）</h4>
                        <span>
                            <ul>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第3条（ユーザーIDおよびパスワードの管理）</h4>
                        <ul>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第4条（利用料金および支払方法）</h4>
                        <ul>
                    ...
                    <p class="content">
                        <h4 class="content">第5条（禁止事項）</h4>
                        <span>ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</span>
                        <ul>
                    ...
                    <p class="content">
                        <h4 class="content">第6条（本サービスの提供の停止等）</h4>
                        <ul>
                            <li>
                    ...
                    <p class="content">
                        <h4 class="content">第8条（利用制限および登録抹消）</h4>
                        <ul>
                            <li>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第9条（退会）</h4>
                        <span>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</span>
                    </p>
                    <p class="content">
                        <h4 class="subtitle">第10条（保証の否認および免責事項）</h4>
                        <ul>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第15条（権利義務の譲渡の禁止）</h4>
                        <span>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</span>
                    </p>
                    <p class="content">
                        <h4 class="subtitle">第16条（準拠法・裁判管轄）</h4>
                        <ul>
                            <li>本規約の解釈にあたっては，日本法を準拠法とします。</li>
                            <li>本サービスに関して紛争が生じた場合には，当社の本店所在地を管轄する裁判所を専属的合意管轄とします。</li>
                        </ul>
                        <div class="has-text-right"><span>以上</span></div>
                        <p>2020年3月16日 作成</p>
                    </p>
                </div>
            </div>
            <div class="content">
                <div class="box has-background-light">
                    ...
                    <p class="content">
                        <span>UTUTU（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</span>
                        <h3 class="subtitle">第1条（個人情報）</h3>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第2条（個人情報の収集方法）</h4>
                        <span>当社は，ユーザーが利用登録をする際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。</span>
                    </p>
                    <p class="content">
                        <h4 class="subtitle">第3条（個人情報を収集・利用する目的）</h4>
                        <span>当社が個人情報を収集・利用する目的は，以下のとおりです。</span>
                        <ul>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第4条（利用目的の変更）</h4>
                        <ul>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第5条（個人情報の第三者提供）</h4>
                        <ul>
                            <li>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第6条（個人情報の開示）</h4>
                        <ul>
                            <li>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第7条（個人情報の訂正および削除）</h4>
                        <ul>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第8条（個人情報の利用停止等）</h4>
                        <ul>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第9条（プライバシーポリシーの変更）</h4>
                        <ul>
                    ...
                    <p class="content">
                        <h4 class="subtitle">第10条（お問い合わせ窓口）</h4>
                        <span>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</span>
                        <p>UTUTU に関するお問い合わせ info@ututu.me</p>
                        <div class="has-text-right"><span>以上</span></div>
                        <p>2020年3月16日 作成</p>
                    </p>
                </div>
